...
from grapycal_torch.activation import LeakyReLUNode, ReLUNode
from grapycal_torch.basic import FlattenNode, LinearNode
...
class MnistDatasetNode(SourceNode):
    ...
    def build_node(self):
        ...
        self.size = self.add_slider_control(
            label="size", min=1, max=60000, int_mode=True, name="size"
        )
